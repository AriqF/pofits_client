...
import { AdminPath, UserPath } from "@/utils/global/route-path";
...
export default function PrivacySettings() {
  ...
  } = useForm<ChangePasswordProfileForm>({ reValidateMode: "onSubmit" });
  ...
  return (
    <AdminLayout backTo={AdminPath.PROFILE} title="Pengaturan Privasi Akun">
